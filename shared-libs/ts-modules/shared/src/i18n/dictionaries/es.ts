...
export default {
  ...
  151: 'Los servicios de este registro están en fase de prueba alfa. Se esperan errores que podrían dañar tu sistema. Instálalos bajo tu propio riesgo.',
  152: 'Este es un registro personalizado. Start9 no puede verificar sus servicios, y podrían dañar tu sistema. Instálalos bajo tu propio riesgo.',
  153: 'Registros predeterminados',
  154: 'Registros personalizados',
  851: 'Registros guardados',
  852: 'Alfabético',
  853: 'Actualizado recientemente',
  ...
  582: 'StartOS se ha actualizado, pero esta página sigue ejecutando la interfaz anterior. Actualiza la página para obtener la última versión.',
  606: 'Host',
  607: 'Valor',
  610: 'DNS dinámico',
  ...
  817: 'Un dominio de clearnet accesible desde cualquier lugar en Internet.',
  818: 'Ideal para',
  819: 'Sitios web y API públicos',
  820: 'Acceso remoto sin VPN',
  821: 'HTTPS estándar — nada adicional en lo que confiar',
  822: 'Requiere',
  823: 'Un dominio que te pertenezca',
  824: 'Registro DNS → IP pública de tu puerta de enlace',
  825: 'Reenvío de puertos (normalmente 443)',
  826: 'Más información',
  827: 'Un dominio personalizado que solo funciona en tu LAN o a través de VPN.',
  828: 'Acceso privado personal o compartido',
  829: 'Servicios nunca expuestos a Internet',
  830: 'Cualquier dominio — real o inventado.',
  831: 'Este servidor como servidor DNS de tu puerta de enlace',
  ...
  850: 'Duración',
  854: 'rangos de puertos',
  855: 'Sin rangos de puertos',
  856: 'Sin puertas de enlace',
  857: 'Sin IP WAN',
  858: 'Rango',
  859: 'LAN',
  860: 'LAN+WAN',
  861: 'reenvíe el siguiente rango de puertos a este servidor, tanto para TCP como para UDP, si aún no lo ha hecho',
  862: '¡Importante!',
  863: 'Una mejora importante en el rendimiento de las copias de seguridad de StartOS ha cambiado el formato de copia de seguridad. La copia de seguridad existente en esta unidad —la antigua carpeta "StartOSBackups"— ya está obsoleta y no se puede actualizar. Tu nueva copia de seguridad se creará en una carpeta separada "StartOSBackupsV2".',
  864: 'Haz una copia de seguridad de todo lo que necesites',
  865: 'Como la copia de seguridad antigua ya no se actualizará, asegúrate de seleccionar TODOS los servicios que quieras respaldar. Una vez que esta nueva copia de seguridad se complete correctamente, ELIMINA la antigua carpeta "StartOSBackups" de la unidad para liberar espacio; NO elimines "StartOSBackupsV2".',
  868: 'Opción 1',
  870: 'Opción 2',
  872: 'OK',
