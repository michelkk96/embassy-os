...
export const ENGLISH: Record<string, number> = {
  ...
  'The old "StartOSBackups" folder is larger than the free space remaining on this drive, so a new backup will not fit. You have two options:': 867,
  'Option 1': 868,
  'Delete the old "StartOSBackups" folder from this drive, then try again.': 869,
  'Option 2': 870,
