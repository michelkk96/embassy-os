 ...
 * re-translates live on language change. Plain-string entries become reactive
 * `computed` signals; function/template entries translate inside Taiga's own
 * error computed so they react to the language signal too.
 */
