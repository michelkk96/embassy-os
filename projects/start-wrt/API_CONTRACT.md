...
// Backend: reads `_apf_*`-tagged firewall redirects; names enriched from DHCP
// host entries and the persistent device-name cache.
```
...
**Totals:** 76 RPC methods across 16 categories, plus the HTTP/WebSocket routes
